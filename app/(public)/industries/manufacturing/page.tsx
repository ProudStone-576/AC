...
export const metadata: Metadata = {
  ...
  description:
    "We connect factory floor systems to business technology, predict equipment failures before they happen, and secure industrial networks — without disrupting production.",
}
