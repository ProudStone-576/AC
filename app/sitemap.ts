...
const staticRoutes: {
  ...
  { url: "/locations",                      priority: 0.9, changeFrequency: "monthly" },
  { url: "/locations/toronto",             priority: 0.9, changeFrequency: "monthly" },
  { url: "/locations/vancouver",           priority: 0.8, changeFrequency: "monthly" },
  { url: "/locations/calgary",             priority: 0.8, changeFrequency: "monthly" },
  { url: "/locations/edmonton",            priority: 0.8, changeFrequency: "monthly" },
  { url: "/locations/ottawa",              priority: 0.8, changeFrequency: "monthly" },
  { url: "/locations/montreal",            priority: 0.8, changeFrequency: "monthly" },
  { url: "/locations/winnipeg",            priority: 0.7, changeFrequency: "monthly" },
  { url: "/locations/hamilton",            priority: 0.7, changeFrequency: "monthly" },
  { url: "/locations/kitchener-waterloo",  priority: 0.7, changeFrequency: "monthly" },
  { url: "/locations/mississauga",         priority: 0.7, changeFrequency: "monthly" },
  { url: "/how-we-work",                   priority: 0.7, changeFrequency: "monthly" },
  ...
  { url: "/legal/sla",                    priority: 0.3, changeFrequency: "yearly" },
  { url: "/legal/dpa",                    priority: 0.3, changeFrequency: "yearly" },
  { url: "/legal/acceptable-use",         priority: 0.3, changeFrequency: "yearly" },
]
