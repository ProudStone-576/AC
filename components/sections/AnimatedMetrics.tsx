...
const METRICS = [
  {
    ...
    suffix: "%",
    label: "Uptime SLA",
    descriptor: "contractual commitment across managed environments",
    decimals: 2,
  },
  {
    seq: "02",
  ...
  },
  {
    ...
    suffix: "ms",
    label: "P99 latency",
    descriptor: "across all platform API endpoints",
    decimals: 0,
  },
  {
    seq: "04",
    ...
    suffix: "/7",
    label: "Operations",
    descriptor: "continuous monitoring and incident response",
    decimals: 0,
  },
]
